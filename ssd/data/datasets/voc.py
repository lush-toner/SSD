...
class VOCDataset(torch.utils.data.Dataset):
    ...
    def __len__(self):
        return len(self.ids)
    # read txt file and get file name as list
    @staticmethod
    def _read_image_ids(image_ids):
        ids = []
    ...
    def _get_annotation(self, image_id):
        ...
        for obj in objects:
            ...
            labels.append(self.class_dict[class_name]) # class_name index
