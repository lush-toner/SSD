...
def add_vgg(cfg, batch_norm=False): # '300': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'C', 512, 512, 512, 'M', 512, 512, 512],
    layers = []
    in_channels = 3
    for v in cfg:
        if v == 'M':
    ...
    conv6 = nn.Conv2d(512, 1024, kernel_size=3, padding=6, dilation=6) ### dilation?
...
def add_extras(cfg, i, size=300): # '300': [256, 'S', 512, 128, 'S', 256, 128, 256, 128, 256],
